            ...
            <div
              ...
              onClick={(e) => {
                if (e.target.innerHTML === 'lower arms') {
                  ...
                  setApiUrl('/bodyPart/' + e.target.innerHTML + '?limit=5000');
                }
              }}
            >
              <p className='font-bold rounded-lg m-2 p-1 border border-black hover:bg-black hover:text-white cursor-pointer'>
                {bodypart}
              </p>
            </div>
          );
